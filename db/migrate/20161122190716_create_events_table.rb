class CreateEventsTable < ActiveRecord::Migration
  def change
    create_table :events do |t|
      ...
      t.string :sender_text, limit: nil
      t.string :at_player
      t.string :at_player_team
      t.string :at_player_text, limit: nil
...
sys_event = ["7b57f50c5a9c457790ec41e14fa8e7b0.d",
 1479838506436,
 {"plext"=>
   {"text"=>
...
player_event = ["f519ecc59cf54a03ae04183e4309015b.d",
   1479836463408,
   {"plext"=>
